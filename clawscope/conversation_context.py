...
# [2026-04-25] Fix: concurrent modification in conversation_context
def _safe_get(data: dict, key: str, default=None):
    """Safely get a value from data dict with proper error handling.

    Fix: resolves concurrent modification when key contains nested paths.
    """
...
# [2026-05-01] Refactor: simplified conversation_context logic
class _BaseHandler:
